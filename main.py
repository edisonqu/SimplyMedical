...
medical_jargon = {
  ...
  "acetaminophen": "antipyretic (Tylenol)",
  ...
  "alzheimer's": " a progressive disease with specific brain abnormalities marked by memory loss and progressive inability to function normally at even the simplest tasks",
  "AMA": " against medical advice or American Medical Association",
  "ambu": " handheld squeeze bag attached to a face mask. see also bagging",
  ...
  "anaphylactic": "like difficulty in breathing and sometimes results in death.",
  ...
  "angina": " a severe acute attack of cardiac pain",
  ...
  "aortic": " when the aorta bursts",
  "arterial": " insertion of an IV line into an artery",
  ...
  "atypical": " a form of angina pectoris that does not manifest the typical angina symptoms of chest pain, shortness of breath, etc, but which comes on suddenly and occurs without a predisposing cause",
  "AZT": " an antiviral drug (zidovudine) prescribed for the treatment of AIDS",
  "Babinski's": " also known as the plantar reflex; the movement of the big toe upward instead of downward; used to test injury to, or diseases of, the upper motor neurons",
  ...
  "Barlow's": " infantile scurvy",
  "Betadine": "iodine, a preparation used as a surgical scrub that is available in liquid and aerosol forms",
  "bilateral": " blood in both sides of the pleura, the membrane covering the lung",
  "blood": "tipped stick",
  "BLS": " abbreviation for basic life support; includes CPR and removal of foreign body airway obstruction",
  "body": " a drug courier who swallows condoms filled with cocaine or heroin in order to smuggle them into a country and then passes them rectally after he's safe",
  "bolus": "level concentrations to a therapeutic level",
  "bounceback": " a patient who returns to the ER with the same complaint shortly after being released",
  "bowel": " manual removal of impacted fecal matter from a patient's rectum",
  "BP": " abbreviation for blood pressure",
  "bradycardic": " a slowing of the heart rate to less than 50 beats per minute",
  "breath": " the sounds heard through a stethoscope placed on the chest over the lungs",
  ...
  "calcium": " a kidney stone",
  "Calot's": " the cystic duct, the common duct, and the liver",
  "calyx": "shaped part of the kidneys",
  "capillary": " when a fingernail is pressed, the nail bed turns white. Capillary refill refers to the return of the nail bed to pink color. Good cap refill is two seconds or less",
  "capoten": " an antihypertensive and ACE inhibitor prescribed for high blood failure and congestive heart failure. It is also sold under the trade name capoten (captopril is the drug's generic name)",
  ...
  "cardiac": " compression of the heart from fluid such as an effusion or blood",
  "cardiomyopathy": " a disorder of the heart muscle that can often be fatal",
  "CAT": " Computerized axial tomography",
  "catcher's": " a device used for a patient with bleeding varices in the throat that allows a tube with two balloons attached to be positioned securely in the throat and inflated. The balloons then put pressure on the enlarged veins in order to stop the bleeding",
  "CBC": "purpose blood test; combining diagnostic evaluations of red blood cell count, white cell count, erythrocyte indices, hematocrit, and a differential blood count",
  ...
  "central": " the central location in the circulation of the vein used, usually in the internal jugular and subclavian veins in the neck, or the femoral veins in the groin. This has the benefit of being able to send more fluid into the body",
  "cephalosporin": " an antibiotic",
  "cesarean": " surgical delivery of a baby through the abdominal wall",
  "champagne": "called because the supervising resident has to, by custom, buy the student a bottle champagne",
  "Chem": " a battery of blood chemistry tests; the seven parts of a Chem 7; sodium, potassium, chloride, bicarbonate, blood urea nitrogen (BUN), creatinine, and glucose",
  "chest": "ray",
  ...
  "coag": " a blood test used to determine the clotting factors of a patient's blood",
  "code": " term used when a patient doesn't make it to the bathroom in time",
  ...
  "crispy": " irreverent ER slang for a seriously burned patient",
  ...
  "cystic": " a lung disease that causes the production of thick mucus in the lungs, hampering breathing",
  ...
  "dead": " ER slang for a fat man who dies while shoveling snow",
  ...
  "DIC": " diagnosis made by ruling out many disorders. The patient usually presents with symptoms that can be shared by many conditions. For example, chest pain can be caused by many diseases or conditions, and each one must be ruled out to arrive at the correct diagnosis",
  "digitalis": " a drug prescribed for congestive heart failure",
  "dilantin": " an anticonvulsant drug used to prevent seizures",
  "diplopia": " double vision",
  "disaster": " the following color tags are used to immediately triage patients during a mass casualty event: Green is walking wounded; yellow is urgent; red is critical; black is DOA",
  "distal": " the pulse farthest from the heart",
  ...
  "ectopic": " the development of the fetus in the fallopian tube instead of in the womb",
  "edema": " excessive accumulation of fluid",
  "elavil": " trade name for amitriptyline",
  "electrolyte": " tests the basic chemicals in the body; sodium, potassium, chloride, and bicarbonate",
  ...
  "esmolol": "blocking drug",
  "ETA": " abbreviation for Estimated Time of Arrival",
  "Feldene": "inflammatory drug (piroxicam) prescribed for arthritis and other forms of joint and bone inflammation",
  "fentanyl": "acting morphine like narcotic analgesic of high poitency, often used in conjunction with other drugs. Fentanyl can enhance the effect of certain narcotics (including morphine)",
  "fetal": " a term used to describe a number of critical conditions threatening the live delivery of a fetus",
  ...
  "first": " a burn affecting only the epidermis. The color of the burn is red, capillary refill is present, the skin texture is normal, and the burn heals in five to ten days with no scarring",
  ...
  "fluoroscope": "ray machine",
  "Focused": " a history and physical examination. H and P is the term used to describe an examination that results in a patient history and makes an assessment of his or her condition. The patient is physically examined and then talked to regarding his or her complaint and the doctor then makes a probably diagnosis. Focused means do not examine a patient's feet or do a rectal if they're complaining of a headache and double vision",
  "foley": " a foley (indwelling) catheter. This is a thin flexible tube inserted into the urethra in order to drain the bladder",
  "gastric": " irrigation of the stomach when poisoning or bleeding is suspected, or to remove ingested toxins before they enter the blood stream",
  ...
  "GI": " a commonly used mixture of liquid donnatal (which stops gastrointestinal spasms), viscous lidocaine and mylanta (which counteracts the stomach acid and soothes the stomach). This concoction is often given to patients presenting with severe heartburn, signs of an ulcer, or indications of an excess production of stomach acid",
  "giardiasis": " intestinal infection with the giardia bacteria",
  "Glasgow": " this scale is used to quickly determine the status and degree of injury of a trauma victim to the head",
  "\"Glove": " see bowel disimpaction",
  "golden": " also known as the golden window. When treating a patient who has had a myocardial infarction, emergency personnel must be extremely careful during the first hour. The ventricles are very sensitive during this period and life threatening arrythmias can occur",
  ...
  "Gram's": " a stain test that identifies various forms of bacterial microorganisms",
  "granuloma": " a tumor",
  "GSW": " abbreviation for gunshot wound",
  "guiac": " a test of stool with a gloved finger inserted looking for blood",
  "H": " see also Focused H and P, history and physical: the initial evaluation and examination of a patient",
  "haldol": " a drug (haloperidol) used for psychotic disorders, Tourette's syndrome, and hyperactivity in children",
  "heart/lung": " using a machine to breathe and circulate blood for a patient for any number of clinical or surgical reasons, like to also used to rewarm the blood of severely hypothermic patient",
  "heimlich": "aid measure used to dislodge something caught in a person's throat that is obstructing breathing",
  ...
  "hepatolenticular": " excessive accumulation of copper in the kidney, liver, and brain, which if untreated, is invariably fatal",
  "holosystolic": " a heart murmur that begins with the heart sound S1 and occupying all of the systole, then reaching S2. S1 and S2 refer to heart sounds noted during palpation",
  "Horner's": " the term used to describe the clinical profile of myosis, ptosis, and anhidrosis, which usually follows paralysis of the cervical sympathetic nerves on one side of the body",
  ...
  "irritable": " a chronic and unpleasant gastrointestinal condition marked by abdominal cramping, and diarrhea or constipation",
  "ischemia": " when the heart is starving for oxygen",
  "Isordil": " an antianginal agent",
  "IV": " injecting medication rapidly into a vein to hit the blood system all at once",
  "K": "soluble lubricant",
  "KCl": "el) a potassium supplement, used to replace lost potassium in a patient",
  ...
  "lithium": "depressive illness",
  "lithotripsy": " breaking up the renal calculi (kidney stones) with sound waves so they can be passed in the urine",
  "lumbar": " the withdrawal of cerebrospinal fluid through a hollow needle inserted into the lumbar region between the L4 and L5 vertebrae. Also referred to as a spinal tap",
  "lytes": " abbreviation for an electrolyte analysis (pronounced \"lights\")",
  "macrodantin": "infective antibiotic used to prevent and treat urinary tract infections",
  "macrosomic": " fetal weight of more than 4,000 grams",
  "magnesium": "acting laxative",
  ...
  "metacarpal": " a fracture of one of the five bones that form that part of the hand between the wrist and the fingers",
  "methylprednisolone": "inflammatory steroid",
  ...
  "myocardial": " a heart attack",
  "myosis": " excessive contraction of the pupil in the eye",
  "M&M": "morbidity. More malignant programs use it to embarrass residents and their mistakes. If refreshments are served, often the nickname is death and donuts (D&D)",
  "narcan": " naloxone, a drug used to counteract drug overdoses",
  "necrotic": " dead, as in \"necrotic tissue\"",
  "needle": " see cricothyroidotomy",
  "NG": " abbreviation for a nasogastric tube",
  "NICU": " abbreviation for the neonatal intensive care unit",
  "nitro": " an IV infusion of nitroglycerine",
  "nitroglycerine": " an antianginal agent",
  "norcuron": "sequence intubation",
  "normal": " a normal heart rate, which is between 60 and 80 beats per minute in an adult",
  "nosocomial": " opportunistic infections contracted while in the hospital, eg a urinary tract infection a patient develops from his foley catheter",
  "NPO": " abbreviation for nothing by mouth (from the Latin Nil peros)",
  "NS": " abbreviation for normal saline solution",
  "NSAID": "inflammatory drug (eg Motrin, Advil, etc)",
  "O": " type O, Rhesus negative blood; also called universal donor blood since any human can receive O negative blood without complication",
  "orbital": " a fracture of the bony socket that holds the eyeball",
  "osteosarcoma": " bone cancer",
  "otitis": " an infection of the middle ear",
  ...
  "perfed": " when an infected appendix bursts opens and spills into the gut",
  "pericardial": " blood or fluid leaking into the pericardium",
  "pericardium": " the sac that envelops the heart",
  "peritoneal": " irrigation of the peritoneum",
  ...
  "placental": " the placenta separates from the lining of the womb too early, resulting in pain and bleeding",
  ...
  "PQRST": "like or dull and throbbing?; R stands for \"radiation\": Does the pain radiate anywhere beyond the chest, such as into the arm or jaw?; S stands for \"severity\": On a scale of 1 to 10, with 1 being almost no pain at all and 10 being the worst pain imaginable, what number does the pain rank?; T stands for \"timing\": What specifically, were you doing when the pain began and how long have you had it?",
  ...
  "pulsus": " a condition in which the pulse pressure declines during respiratory inspiration",
  "PVCs": " premature cardiac ventricular contractions",
  "pyelogram": "ray of the kidneys using an intravenously inserted dye",
  "q": " every iteration, ie a med of Q5min would be every five minutes, or Q6h is every 6 hours",
  "rape": " a package containing envelopes for the collection of hair, sperm, and blood samples of a rape victims, as well as the official reporting forms",
  "rapid": " a device that transports blood into the system at a fast rate to help prevent hypohemia",
  "reflux": " moving backward in the esophagus",
  "renogram": "ray of the kidneys",
  ...
  "Ringer's": " an intravenous solution consisting of salt, potassium, and calcium boiled in water used to treat dehydration",
  "saline": " a blood volume substitute made of salt and water, a temporary substitute for lost blood",
  "schizophrenia": " a mental disorder marked by hallucinations, delusions, and disintegration of the thought processes",
  "scoop": " a term used by EMTs and ER personnel for a situation where no treatment is possible at an accident scene and all they can do it \"scoop\" up the victims and \"run\" with them to the ER",
  "second": "60 days with a dense scar",
  "sed": " erythrocyte sedimentation rate, a red blood count used to determine inflammation and tissue destruction",
  "sepsis": " a very severe infection",
  "serum": " a test for pancreatitis",
  ...
  "solu": " methylprednisolone, a form or prednisone, an adrenal corticosteroid, a powerful steroid",
  ...
  "stomach": " a large tube called an Ewald is inserted into the stomach, sucks out the contents, then the stomach is flushed out with clear water then charcoal and a cathartic (a fluid that passes through the bowel quickly)",
  ...
  "succinylcholine": "acting muscle relaxant",
  "systolic": " a cardiac murmur that occurs between the first and second heart sounds",
  "T3,": " Third thoracic vertebrae; fourth thoracic vertebrae, etc",
  ...
  "tension": " a collapsed lung",
  "tetralogy": " a surgically correctable congenital heart defect that consists of pulmonary stenoisis. hypertrophy (enlargement), of the right ventricle, a ventricular septal defect, and a shift of the aorta to the right",
  "third": " a burn that damages (or destroys) the full thickness of the skin and the tissues underneath. The color of the burn is white, black, or brown; capillary refill is absent; the skin texture is leathery; and there is no spontaneous healing",
  ...
  "tib": " fracture of the tibia & fibula in part of the leg below the knee",
  ...
  "torsades": " a type of polymorphic ventricular tachycardia in which the heart races at extremely high rates in an arrhythmia",
  "tox": " toxicological analysis of the blood, ordered when a drug overdose is suspected and the drugs need to be identified",
  ...
  "tracheal": " a physical shift of the windpipe due to trauma",
  "trauma": " an emergency room with a trauma surgeon on duty",
  "triage": " the system of prioritizing patients in an emergency situation in which there are a great number of injured or ill",
  "type": " blood typing to identify patient's blood type",
  "U/A": " urinalysis, used to test for kidney failure, dehydration, diabetes, undernourishment, or bladder or kidney infection",
  "ulcerative": " an inflammatory and ulcerative condition of the colon",
  "ultrasound": "ray, but which uses sound waves",
  "unstable": " angina pectoris in which the cardiac pain has changed in pattern",
  "uric": " an acid formed in the breakdown of nucleoproteins in tissues; often tested when gout is suspected since a high uric acid content in the blood often causes gout symptoms and the formation of stones",
  "UTI": " abbreviation for urinary tract infection",
  "V/Q": "perfusion scan, used to confirm a diagnosis of pulmonary embolism",
  "valsalva": " when a patient is instructed to blow on his or her thumb to maximize intrathoracic pressure.. It is used when cardiac trouble is suspected",
  "vecuronium": " see norcuron",
  "venipuncture": " the drawing of blood from a vein",
  "ventricular": " rupture of the ventricular septum caused by mechanical failure of infarcted cardiac tissue",
  ...
  "vitamin": " ER shorthand for haldol",
  ...
  "Whipple": " a pancreatotomy, where the distal stomach, gallbladder, and duodenum are usually also taken out during the surgery, and they usually leave a little of the distal pancreas behind."
}
...
for term in medical_PDF.split():
    if term in medical_jargon:
        definition = medical_jargon[term]
        newText = newText.replace(term, definition)
        # MEDICAL_API_KEY = "08e61de9-267d-4629-8aa2-4b566f0c68a0"
        # response = requests.get(f"https://www.dictionaryapi.com/api/v3/references/medical/json/{term}?key={MEDICAL_API_KEY}")
        # shortdef = response.json()[0]['shortdef'][0]
        # print(shortdef)

# works btw... that's fire

# ill implement grammar now and turn it into a webap 
# say less <3
